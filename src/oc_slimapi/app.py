...
from .routes import agent, command, events, health, messages, metrics, sessions, token_stream
...
for router in (health.router, agent.router, command.router, sessions.router, messages.router, events.router, metrics.router, token_stream.router):
